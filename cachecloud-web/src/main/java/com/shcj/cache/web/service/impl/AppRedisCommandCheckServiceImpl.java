...
import com.shcj.cache.web.service.AppRedisCommandCheckService;
import com.shcj.cache.web.vo.AppRedisCommandCheckResult;
import com.shcj.cache.web.vo.AppRedisCommandCheckVo;
import com.shcj.cache.web.vo.InstanceRedisCommandCheckResult;
import com.shcj.cache.web.vo.RedisCommandCheckResult;
...
public class AppRedisCommandCheckServiceImpl implements AppRedisCommandCheckService {
    ...
    private String checkByInfo(InstanceInfo instanceInfo, long startTime, Integer maxTry, RedisConstant redisConstant, String indicateName, String expectValue) {
        ...
        long costTime = 0L;
        try (Jedis jedis = redisCenter.getJedis(appId, host, port)) {
            int retryTimes = 1;
            long sleepTime = 500L;
            ...
            while (reConfirmFlag && retryTimes < maxTry) {
                try {
                    Thread.sleep(Math.min(retryTimes * sleepTime, 3000L));
