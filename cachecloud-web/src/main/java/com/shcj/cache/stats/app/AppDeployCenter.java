...
import com.shcj.cache.constant.DataFormatCheckResult;
import com.shcj.cache.constant.HorizontalResult;
...
public interface AppDeployCenter {
    ...
    /**
     * 管理员新建应用（无审批），用于直接进入部署流程
     */
    long createAppForAdminDeploy(AppDesc appDesc, AppUser appUser, String memSize, String maxMemoryPolicy);
