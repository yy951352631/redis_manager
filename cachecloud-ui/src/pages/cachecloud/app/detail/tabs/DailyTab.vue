...
<template>
  <div v-loading="loading" class="app-daily-page" :class="[{ 'app-daily-page--no-data': daily && !daily.hasData }]">
    <div class="app-daily-toolbar">
      <div class="app-daily-toolbar__search">
        ...
        />
        <el-button type="primary" class="app-daily-query-btn" :icon="Search" @click="fetchData">
          查询
        </el-button>
      </div>
    </div>
    ...
    <div v-if="daily && !daily.hasData" class="app-daily-empty-hint">
      <el-icon class="app-daily-empty-hint__icon">
        <InfoFilled />
      </el-icon>
    ...
    <div class="app-daily-section app-daily-section--server">
      ...
      <div class="app-daily-grid">
        <div class="app-daily-card app-daily-card--red">
          <div class="app-daily-card__label">
            慢查询个数（全天）
          </div>
