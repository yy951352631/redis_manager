...
import com.shcj.cache.constant.ReshardStatusEnum;
import com.shcj.cache.dao.AppDao;
import com.shcj.cache.dao.InstanceReshardProcessDao;
import com.shcj.cache.dao.ResourceDao;
import com.shcj.cache.entity.AppDesc;
import com.shcj.cache.entity.InstanceInfo;
import com.shcj.cache.entity.InstanceReshardProcess;
            ...
            try {
                boolean isClusterMeet = new IdempotentConfirmer() {
                    ...
                    public boolean execute() {
                        ...
                        return meet != null && "OK".equalsIgnoreCase(meet);
                    }
                }.run();
                if (isClusterMeet) {
                    return true;
            ...
            for (final String key : keys) {
                boolean isKeyMigrate = new IdempotentConfirmer() {
                    ...
                    public boolean execute() {
                        ...
                        return response != null && ("OK".equalsIgnoreCase(response) || "NOKEY".equalsIgnoreCase(response));
                    }
                }.run();
                if (!isKeyMigrate) {
            ...
            public boolean execute() {
                ...
                for (HostAndPort hostAndPort : masterNodesList) {
                    ...
                    try {
                        ...
                        isOk = response != null && "OK".equalsIgnoreCase(response);
                        if (!isOk) {
    ...
    private int migrateSlotData(long appId, final Jedis source, final Jedis target, final int slot, int isPipeline, String password, List<Integer> versionList) {
        ...
        boolean isImport = new IdempotentConfirmer() {
            ...
            public boolean execute() {
                ...
                return importing != null && "OK".equalsIgnoreCase(importing);
            }
        }.run();
        if (!isImport) {
            isError = true;
        ...
        boolean isMigrate = new IdempotentConfirmer() {
            ...
            public boolean execute() {
                ...
                return migrating != null && "OK".equalsIgnoreCase(migrating);
            }
        }.run();
