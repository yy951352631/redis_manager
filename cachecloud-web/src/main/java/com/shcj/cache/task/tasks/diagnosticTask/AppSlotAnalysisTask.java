    ...
    public TaskFlowStatusEnum createAppSlotAnalysisTask() {
        ...
        for (RedisServerNode redisServerNode : redisServerNodes) {
            ...
            try {
                ...
                logger.info(marker, "appId {} {}:{} instanceSlotAnalysisTask create successfully, childTaskId={}", appId, host, port, childTaskId);
            } catch (Exception e) {
                throw new BizException("appId {} {}:{} instanceSlotAnalysisTask create fail", appId, host, port, e);
            }
        }
        return TaskFlowStatusEnum.SUCCESS;
    }
    ...
    public TaskFlowStatusEnum waitAppSlotAnalysisTaskFinish() {
        for (RedisServerNode redisServerNode : redisServerNodes) {
            ...
            if (taskFlowStatusEnum.equals(TaskFlowStatusEnum.ABORT)) {
                throw new BizException("appId {} {}:{} instanceSlotAnalysisTask execute fail, childTaskId={}", appId, host, port, childTaskId);
            } else {
