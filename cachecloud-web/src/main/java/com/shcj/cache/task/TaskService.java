...
//                                 int sourcePort, String targetHost, int targetPort, long parentTaskId);
     ...
     * @return
     */
    long addRedisClusterAppTask(long appId, long appAuditId, int maxMemory, List<String> redisServerMachineList, List<String> redisSlaveMachineList, String dbVersion, String moduleinfos, long parentTaskId);

    /**
     * redis sentinel集群
     */
    long addRedisSentinelAppTask(long appId, long appAuditId, int maxMemory, List<String> redisMasterMachineList, List<String> redisSlaveMachineList,
    ...
    /**
     * 综合键值分析（一次 SCAN：类型/TTL/空闲/大小/Top10）
     */
    long addRedisServerCombinedKeyAnalysisTask(long appId, long auditId, String host, int port, long parentTaskId,
    ...
    long addInstanceDelKeyConfirmTask(long appId, String host, int port, String pattern, long auditId,
