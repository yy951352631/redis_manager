  ...
  <div class="quartz-page">
    <div class="page-header">
      <div class="page-actions">
        ...
        <el-button type="primary" :icon="Search" @click="fetchJobs">
          查询
        </el-button>
      </div>
    </div>
        ...
        <el-table-column label="操作" width="220" fixed="right">
          <template #default="{ row }">
            <div class="table-actions">
              <el-button v-if="row.paused" type="success" size="small" @click="handleResume(row)">
                恢复
              </el-button>
              <el-button v-else type="warning" size="small" @click="handlePause(row)">
                暂停
              </el-button>
